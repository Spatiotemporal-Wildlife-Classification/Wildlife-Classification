...
\begin{IEEEkeywords}
Wildlife Classification, Convolutional Neural Network (CNN), Meta-data, Spatio-temporal, 
\end{IEEEkeywords}

\section{Introduction}
    Test use of bibtext file \cite{gomez-donoso_escalona_pérez-esteve_cazorla_2021} 
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.49\textwidth]{images/UMlogo.jpg}}
